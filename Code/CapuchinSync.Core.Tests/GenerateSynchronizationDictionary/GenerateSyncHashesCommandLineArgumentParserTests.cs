...
namespace CapuchinSync.Core.Tests.GenerateSynchronizationDictionary
{
    ...
    public class GenerateSyncHashesCommandLineArgumentParserTests
    {
        ...
        private LoggingLevelCommandLineParser _loggingCommandParser;
        ...
        public void SetUp()
        {
            ...
            _loggingCommandParser = new LoggingLevelCommandLineParser();
        }
        ...
        public void Constructor_EverythingShouldBePeachy()
        {
            ...
            var parser = new GenerateSyncHashesCommandLineArgumentParser(new[] {rootDir}, _fileSystem, _loggingCommandParser);
        ...
        public void Constructor_ExtensionsToExclude_ShouldContainExtensionsSpecifiedAtCommandline()
        {
            ...
            var parser = new GenerateSyncHashesCommandLineArgumentParser(new[] { rootDir, $"{pref}{extension1}", $"{pref}{extension2}" }, _fileSystem, _loggingCommandParser);
        ...
        public void Constructor_ExtensionsToExclude_ShouldNotCareAboutCaseOfPrefix()
        {
            ...
            const string rootDir = "blah";
            const string pref = GenerateSyncHashesCommandLineArgumentParser.ExcludeFilePrefix;
            var parser = new GenerateSyncHashesCommandLineArgumentParser(new[] { rootDir, $"{pref.ToUpperInvariant()}{extension1}", $"{pref.ToLowerInvariant()}{extension2}" }, _fileSystem, _loggingCommandParser);
        ...
        {
            var parser = new GenerateSyncHashesCommandLineArgumentParser(new string[] { }, _fileSystem, _loggingCommandParser);
        ...
        public void Constructor_ShouldTriggerDirectoryDoesNotExistErrorCode()
        {
            ...
            var parser = new GenerateSyncHashesCommandLineArgumentParser(new [] { "thisIsTheDirectoryArgumentAndShouldBeFine" }, _fileSystem, _loggingCommandParser);
        ...
        {
            var parser = new GenerateSyncHashesCommandLineArgumentParser(new [] { "thisIsTheDirectoryArgumentAndShouldBeFine", "invalidPrefix:whatever"}, _fileSystem, _loggingCommandParser);
